...
def run(use_mock: bool, episode: str, log: bool):
    ...
    print(f"  {'sym':<6}{'px':>7}{'gap%':>7}{'rvol':>6}{'dVWAP%':>8}{'float':>10}  flags / decision")
    print("  " + "-" * 64)
    ...
    if log:
        n = RunnerLog(episode).log_candidates(cands)
